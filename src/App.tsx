          ...
          >
            {workspaceView === "channels" && (
              <ChannelsView
                ...
                setChannelComposer={setChannelComposer}
                channelDraftAttachments={channelDraftAttachments}
                channelAttachmentError={channelAttachmentError}
                setChannelAttachmentError={setChannelAttachmentError}
                isChannelCollaborating={isChannelCollaborating}
                handleSendChannelMessage={handleSendChannelMessage}
                ingestComposerFiles={ingestComposerFiles}
                removeDraftAttachment={removeDraftAttachment}
                channelFileInputRef={channelFileInputRef}
                channelMentionCandidates={channelMentionCandidates}
                attachmentLibrary={attachmentLibrary}
                selectedChannelDelegations={selectedChannelDelegations}
                updateChannelMemberTarget={updateChannelMemberTarget}
                allAgents={allAgents}
                setSelectedAgentId={setSelectedAgentId}
                setActivityDrawerTab={setActivityDrawerTab}
            ...
            {workspaceView === "council" && (
              <CouncilView
                councilSessions={councilSessions}
                selectedCouncilSession={selectedCouncilSession}
                selectedCouncilSessionId={selectedCouncilSessionId}
                setSelectedCouncilSessionId={setSelectedCouncilSessionId}
                isStartingCouncil={isStartingCouncil}
                isSendingCouncilMessage={isSendingCouncilMessage}
                councilError={councilError}
                backendError={backendError}
                allAgents={allAgents}
                handleStartCouncilSession={handleStartCouncilSession}
                handleSendCouncilReply={handleSendCouncilReply}
              />
            )}
            {workspaceView === "delegations" && (
              <DelegationsView
            ...
            {workspaceView === "activity" && (
              <ActivityView
                ...
                workspaceInFlightCount={workspaceInFlightCount}
                workspaceAttentionCount={workspaceAttentionCount}
                activityMetricCards={activityMetricCards}
                selectedActivityRun={selectedActivityRun}
                refreshRuntimeRuns={() => void refreshRuntimeRuns()}
                isLoadingRuntimeRuns={isLoadingRuntimeRuns}
                runtimeRunsError={runtimeRunsError}
                allAgents={allAgents}
                setSelectedActivityRunId={setSelectedActivityRunId}
                handleRetryRun={handleRetryRun}
                handleResumeRun={handleResumeRun}
                handleCancelRun={handleCancelRun}
                isMutatingRunId={isMutatingRunId}
                setSelectedFilePreviewPath={setSelectedFilePreviewPath}
                setActivityDrawerTab={setActivityDrawerTab}
                activityFocusAgent={activityFocusAgent}
                activityFocusPresence={activityFocusPresence}
                activityFocusRuns={activityFocusRuns}
                activityFocusCapabilityGroups={activityFocusCapabilityGroups}
              />
            )}
            {workspaceView === "chat" && (
